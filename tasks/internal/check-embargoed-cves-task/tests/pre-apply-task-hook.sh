...
kubectl create secret generic osidb-service-account --from-literal=name=SENSITIVE_DATA_myname --from-literal=base64_keytab=SENSITIVE_DATA_OWEyMmJmYzgtYzJkZi00Y2VhLWJkNWItYjMxNzYxZjFkM2M0Cg== --from-literal=osidb_url=SENSITIVE_DATA_myurl
