...
kubectl create secret generic package-collection-secret --from-literal=gitlab-access-token=SENSITIVE_DATA_gitlab-access-token \
  --from-literal=gitlab_host=SENSITIVE_DATA_gitlab_host --from-literal=git_author_name=SENSITIVE_DATA_git_author_name \
  --from-literal=git_author_email=SENSITIVE_DATA_git_author_email --from-literal=git_repo="SENSITIVE_DATA_package-collection-utils"
